...
// um �nderungen ermitteln zu k�nnen und entsprechende Routinen aufzurufen.
...
// l�scht Flags, die in delete_bitmask '1' sind
...
// Alle �nderungen seitens Bedienelemente werden hier eingetragen und das
...
// Tabs 16-23, #1144 ff.
    edit_LogicalTab_PHR_WersiBoehm[@edit_LogicalTabs + 16]   : Boolean;  // B�hm Phasing Rotor
...
// Tabs 24-31, #1152 ff.
  edit_LogicalTabs_KeyingModes[@edit_LogicalTabs + 24]: Array[0..7] of Boolean;
    ...
    edit_LogicalTab_EG_mask2dry[@edit_LogicalTabs + 30]: boolean;     // Electronic Gating Option, Enables => Fu�lagen auf Dry
...
// #############################################################################
// au�erhalb Tabelle, da nur tempor�r benutzt
// #############################################################################
...
// "Virtuelle" Bedienelemente (Schalter und Analogwerte)
// Alle �nderungen seitens Bedienelemente werden hier zuerst eingetragen.
// Dann wird der neue Wert mit dem alten in_old verglichen, die entsprechende
// Aktion ausgef�hrt bzw. Routine aufgerufen
// und anschlie�end_old auf den neuen Wert gesetzt.
...
// Tabs 16-23, #1144 ff.
    edit_LogicalTab_PHR_WersiBoehm_flag[@edit_LogicalTabs_flag + 16]   : Byte;  // B�hm Phasing Rotor
...
// Tabs 24-31, #1152 ff.
  edit_LogicalTabs_KeyingModes_flag[@edit_LogicalTabs_flag + 24]: Array[0..7] of Byte;
    ...
    edit_LogicalTab_EG_mask2dry_flag[@edit_LogicalTabs_flag + 30]: Byte;     // Electronic Gating Option, Enables => Fu�lagen auf Dry
...
// #1260 ff. "Drehkn�pfe", exklusive Stellungen, werden auf edit- oder Tab-Werte umgesetzt
