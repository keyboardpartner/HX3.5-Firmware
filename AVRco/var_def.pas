...
// ---------------------------- MenuPanel --------------------------------------
  ...
  MenuIndex_Requested: Byte;  // anzuzeigendes Men� wenn <> 255
  MenuIndex_Splash,
  MenuIndex_SplashIfEnabled: Byte;  // kurz anzuzeigendes Men� wenn <> 255
  MenuIndex, LastMainMenuIndex: Byte;
  ValueChangeMode,    // Men�-Modus: Wechseln wenn FLASE oder Wert wenn TRUE
  ...
  SingleDBsetSelect: Byte; // Enth�lt Manual 0..2
...
// ------------------------------- MIDI ----------------------------------------
  ...
  MIDI_NewSwellVal: Byte;  // Wird bei �nderung alle 8ms gesendet
...
// ----------------------------- Hardware --------------------------------------
  ...
  ReverbKnob_old: Byte;  // Reverb-Program senden falls ge�ndert, sonst nur Level
...
// 7 Presets
  ...
  InsertVibratoUpper[@Inserts,2]: bit; // wird st�ndig mit edit_LogicalTab_VibOnUpper �berschrieben
  InsertVibratoLower[@Inserts,3]: bit; // wird st�ndig mit VibOnLower �berschrieben
...
// -------------------------- zus�tzliche Arrays -------------------------------
  ...
  block_CommonPreset[@BlockBuffer8 + 268]:  byte;  // #268, wird nicht bei edit_CommonPreset �berschrieben
