...
s_MidiDebugStrArr: array[0..511] of String[23] = (
  ...
  'Module Rev Vol',  // 1091
  'Module Efx Vol',  // 1092
  'Module Swell Vol',  // 1093
  'Module Front Vol',  // 1094
  'Module Rear Vol',  // 1095
  'Upr Env DB 16',  // 1096
  ...
  'Module Ext Rotary Vol Left',  // 1122
  'Module Ext Rotary Vol Right',  // 1123
  ...
  'No 1 DB when Perc ON',  // 1357
  'DB 16 Foldback Mode',  // 1358
  'Higher Foldback',  // 1359
  'Contact Spring Flex',  // 1360
  'Contact Spring Damp',  // 1361
  'Perc On Live DB only',  // 1362
  ...
  'Current Vib Setup Num',  // 1409
  'Current PHR Setup Num',  // 1410
  'Current Perc Menu Num',  // 1411
  'Current Rev Menu Num',  // 1412
  '(none)',  // 1413
  '(none)',  // 1414
  '(none)',  // 1415
  'Mixt DB 10, Lvl BB 9',  // 1416
  'Mixt DB 10, Lvl BB 10',  // 1417
  'Mixt DB 10, Lvl BB 11',  // 1418
  'Mixt DB 10, Lvl BB 12',  // 1419
  'Mixt DB 10, Lvl BB 13',  // 1420
  'Mixt DB 10, Lvl BB 14',  // 1421
  '(none)',  // 1422
  '(none)',  // 1423
  'Mixt DB 11, Lvl BB 9',  // 1424
  'Mixt DB 11, Lvl BB 10',  // 1425
  'Mixt DB 11, Lvl BB 11',  // 1426
  'Mixt DB 11, Lvl BB 12',  // 1427
  'Mixt DB 11, Lvl BB 13',  // 1428
  'Mixt DB 11, Lvl BB 14',  // 1429
  '(none)',  // 1430
  '(none)',  // 1431
  'Mixt DB 12, Lvl BB 9',  // 1432
  'Mixt DB 12, Lvl BB 10',  // 1433
  'Mixt DB 12, Lvl BB 11',  // 1434
  'Mixt DB 12, Lvl BB 12',  // 1435
  'Mixt DB 12, Lvl BB 13',  // 1436
  'Mixt DB 12, Lvl BB 14',  // 1437
  '(none)',  // 1438
  '(none)',  // 1439
  '(none)',  // 1440
  '(none)',  // 1441
  ...
  '(none)',  // 1446
  '(none)',  // 1447
  'Rotary Horn Slow',  // 1448
  'Rotary Rotor Slow',  // 1449
  'Rotary Horn Fast',  // 1450
  'Rotary Rotor Fast',  // 1451
  'Rotary Horn Ramp Up',  // 1452
  'Rotary Rotor Ramp Up',  // 1453
  'Rotary Horn Ramp Down',  // 1454
  'Rotary Rotor Ramp Down',  // 1455
  'Rotary Spkr Throb',  // 1456
  'Rotary Spkr Spread',  // 1457
  'Rotary Spkr Balance',  // 1458
  'Sync PHR',  // 1459
  'Tube Amp Curve 6550 A',  // 1460
  'Tube Amp Curve 6550 B',  // 1461
  '(none)',  // 1462
  '(none)',  // 1463
  'CONT_BITS, DB 7..0',  // 1464
  'CONT_BITS, DB 11..8',  // 1465
  'ENV_DB_BITS, DB 7..0',  // 1466
  'ENV_DB_BITS, DB 11..8',  // 1467
  'ENV_FULL_BITS, DB 7..0',  // 1468
  'ENV_FULL_BITS, DB 11..8',  // 1469
  'ENV_TO_DRY_BITS, DB 7..0',  // 1470
  'ENV_TO_DRY_BITS, DB 11..8',  // 1471
  'CONT_PERC_BITS, DB 7..0',  // 1472
  'CONT_PERC_BITS, DB 11..8',  // 1473
  'ENV_PERCM_BITS, DB 7..0',  // 1474
  'ENV_PERCM_BITS, DB 11..8',  // 1475
  'ENV_ADSRM_BITS, DB 7..0',  // 1476
  'ENV_ADSRM_BITS, DB 11..8',  // 1477
  '(none)',  // 1478
  '(none)',  // 1479
  'Perc Norm Lvl',  // 1480
  'Perc Soft Lvl',  // 1481
  ...
  'H100 Harp Sustain',  // 1492
  'H100 2nd Voice Lvl',  // 1493
  '(RFU)',  // 1494
  'LED Dimmer',  // 1495
  '2ndDB Select Voice Num',  // 1496
  'Vibrato Knob Mode',  // 1497
  'CommonPreset Save Mask',  // 1498
  '(not used)',  // 1499
  '(not used)',  // 1500
  'Various Configs 1',  // 1501
  'Various Configs 2',  // 1502
  'ADC Config',  // 1503
  '(not used)',  // 1504
  '(not used)',  // 1505
  'Ped DB Config',  // 1506
