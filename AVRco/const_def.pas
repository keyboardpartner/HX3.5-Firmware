...
{$TYPEDCONST OFF}
  ...
  Vers1Str  = '5.840';    // müssen 5 Zeichen sein!
  Vers1Hex: Word = $5800;
...
// #############################################################################
  ...
  // Länge $C439F je XC6S25 Image, Rest frei bis einschließlich Block $31F
...
// @8, #1264 ff. "Drehknüpfe", exklusive Stellungen, werden auf edit- oder Tab-Werte umgesetzt
...
// @240, #1496 ff. Defaults, alles m�gliche, nur zum Start und Reset gelesen
...
// #############################################################################
  ...
  c_board_event_source: Byte    = 2;   // eigene Events durch verkn�pfte Einstellungen
  c_preset_event_source: Byte   = 4;   // durch Preset-Load ausgel�stes Event
  c_editor_event_source: Byte   = 8;   // �ber Serial gekommen
  c_midi_event_source: Byte     = 16;  // �ber MIDI als CC gekommen
  c_midi_sysex_source: Byte     = 32;  // �ber MIDI vom Editor gekommen
...
4: Sinus 2% THD
5: S�gezahn gefiltert für Strings oder Cheesy
...
s_MenuWaveArr: array[0..7] of String[11] = (
  ...
  'B3  32% k2 ',  // 2
  'B3  38% k2 ',  // 3 alte B3
  'Sine 2% k2 ',  // 4 Reiner Sinus, B�hm mit Sinus-Zusatz
  'Sawt Fltrd ',  // 5 S�gezahn gefiltert
...
c_edit_max: Array[0..511] of byte = (
  ...
  127, // #1122 B�hm Module Ext Rotary Volume Left
  127, // #1123 B�hm Module Ext Rotary Volume Right
...
// GMsynth  VolEq  RotyS/F   KnobsTabs  EGPercDBs  PedalDBs  LowerDBs  UpperDBs
  ...
  0, // #1122 B�hm Module Ext Rotary Volume Left
  0, // #1123 B�hm Module Ext Rotary Volume Right
